...
ll <- c(func(q, la, 1999), func(q, la, 2002), func(q, la, 2005), func(q, la, 2008))
yy <- c(1999, 2002, 2005, 2008)
cf <- data.frame(year = yy, motor = cc, region = "Baltimore")
lf <- data.frame(year = yy, motor = ll, region = "Los Angeles County")
cf <- rbind(cf, lf)
